...
document.querySelector('#checkout').innerHTML = `<header class="checkout-header"><a class="back-shop" href="/">← Zurück zum Shop</a><a class="logo" href="/">DUMAH<small>EDITION</small></a><span>Sicherer Checkout</span></header>${steps}<main>${step==='information'?info:step==='shipping'?ship:pay}${summary}</main><footer><span>© 2026 DUMAH EDITION</span><div><a href="/datenschutz/">Datenschutz</a><a href="/agb/">AGB</a><a href="/widerruf/">Widerruf</a><a href="/impressum/">Impressum</a></div></footer>`
